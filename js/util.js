...
HT.util = (function () {
  ...
  function shortDate(k) { const d = parseKey(k); return MONTHS[d.getMonth()] + pad2(d.getDate()); }
  function longDate(k) { const d = parseKey(k); return WD[d.getDay()] + ' ' + MONTHS[d.getMonth()] + ' ' + pad2(d.getDate()) + ' ' + d.getFullYear(); }
